...
A set of tools for managing a BIND9 DNS server for a local area network (LAN).

## Features
### Managing DNS records for devices on a LAN using a network configuration file.
[orgncf-generator](orgncf-generator/README.md) Tree sitter grammar for highlighting and parsing the network configuration file.
